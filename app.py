                        ...
                        lectures: [
                            {
                                ...
                                videoSrc: "https://royalfiletolink.koyeb.app/stream/29260?hash=d0f2cab0ac735468#t=0.5"
                            }
                        ],
                        notes: [], png: [], dpp: []
                    },
...
function renderContentTab(tabName) {
    ...
    list.forEach((entry, index) => {
        ...
        if (tabName === 'lectures' && videoSrc) {
            ...
            container.innerHTML += `
                <div style="width:min(100%,320px); margin:0 auto 12px; background:#ffffff; border:1.5px solid #2d6a4f; border-radius:14px; padding:9px; box-shadow:0 2px 5px rgba(0,0,0,0.04);">
                    <div style="display:flex; align-items:center; justify-content:space-between; gap:8px; padding:1px 2px 7px;">
                        ...
                        <div style="font-size:18px; color:#2d6a4f; flex:0 0 auto;">▶</div>
                    </div>
                    <video controls playsinline preload="metadata" style="width:100%; aspect-ratio:16/9; background:#000000; border-radius:10px; display:block;" onclick="event.stopPropagation();">
