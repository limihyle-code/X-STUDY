...
<div id="batch-details-screen" class="view-screen" style="display:none; position:absolute; top:0; left:0; width:100%; height:100%; background:#ffffff; z-index:85; flex-direction:column;">
    ...
    <div style="flex:1; overflow-y:auto; padding:14px 16px 80px 16px; background:#f8fafc;">
        ...
        <div id="career-will-detail-study-wrap" style="display:none; margin-bottom:12px;">
            <button onclick="startCareerWillStudy()" style="width:100%; background:#5b45e8; color:#ffffff; border:none; padding:14px; border-radius:12px; font-size:16px; font-weight:800; cursor:pointer;">Let's Study</button>
        </div>
...
const instituteBatchesData = {
    ...
    "NEET 12th": {
        ...
        "Career Will": [
            {
                title: "Enthuse 2.0 (Class 12th) Online NEET 2027",
                ...
                subtitle: "Kota's Top HOD Team",
                startDate: "10-Jun-2026",
                description: "Enthuse 2.0 (Class 12th) Online NEET 2027 — Career Will Class 12 NEET batch.",
                studyClassIndex: 0,
                classes: [
                    {
                        name: "Physics By Satyam Mudaliar Sir", chapters: "20 Chapters", icon: "P", bg: "#eff6ff",
                        
                    pageItems: [
                        {title:"All Content", meta:"All Videos | All Exercises | All Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Short Notes || (Only PDF)", meta:"14 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Mind Map || (Only PDF)", meta:"14 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"PYQ's || (Only PDF)", meta:"14 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Summary Lecture and PYQs Discussion", meta:"7 Videos | 7 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Lecture Concise Notes || (Only PDF)", meta:"79 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Handwritten Notes || (Only PDF)", meta:"14 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Satya Darpan Sheets || (Only PDF)", meta:"1 Video | 5 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Neet Replica Practice Sheet", meta:"6 Exercises | 6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"PYQ's Practice Sheet", meta:"6 Exercises | 6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Practice Sheet discussion", meta:"3 Videos | 3 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"NCERT Discussion", meta:"12 Videos | 12 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Sattu Sir ke Concept Capsules", meta:"13 Videos | 13 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Weekly Revision Sheet", meta:"11 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electric Charges and Fields", meta:"19 Videos | 18 Exercises | 37 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electrostatic Potential and Capacitance", meta:"17 Videos | 15 Exercises | 32 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Current Electricity", meta:"15 Videos | 11 Exercises | 23 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Moving Charges and Magnetism", meta:"12 Videos | 8 Exercises | 26 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Magnetism and Matter", meta:"4 Videos | 2 Exercises | 7 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electromagnetic Induction", meta:"8 Videos | 6 Exercises | 17 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Alternating Current", meta:"6 Videos | 5 Exercises | 13 Notes", lectures:[], notes:[], png:[], dpp:[]}
                    ]
                    }
                ],
                infinity: ["Board + NEET Revision", "Doubt Support", "Full Syllabus Tests"]
            }
        ]
    },
    ...
    "NEET 12th Pass": {
        ...
        "Career Will": [
            {
                title: "Yakeen (Dropper) Online NEET 2027",
                ...
                description: "Yakeen (Dropper) Online NEET 2027 — Career Will Class 12th Pass / Dropper NEET batch.",
                studyClassIndex: 0,
                classes: [
                    {
                        name: "Physics by Mr Sir", chapters: "35 Chapters", icon: "P", bg: "#eff6ff",
                        
                    pageItems: [
                        {title:"All Content", meta:"All Videos | All Exercises | All Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Short Notes || (Only PDF)", meta:"6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Mind Map || (Only PDF)", meta:"6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"PYQ's || (Only PDF)", meta:"6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Lecture Concise Notes || (Only PDF)", meta:"4 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Handwritten Notes || (Only PDF)", meta:"4 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electric Charges and Fields", meta:"22 Videos | 11 Exercises | 33 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electrostatic Potential and Capacitance", meta:"18 Videos | 9 Exercises | 27 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Current Electricity", meta:"16 Videos | 5 Exercises | 21 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Moving Charges and Magnetism", meta:"13 Videos | 6 Exercises | 19 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Magnetism and Matter", meta:"4 Videos | 2 Exercises | 6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electromagnetic Induction", meta:"9 Videos | 4 Exercises | 13 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Alternating Current", meta:"1 Video | 1 Note", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Electromagnetic Waves", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Ray Optics and Optical Instruments", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Wave Optics", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Dual Nature of Radiation and Matter", meta:"6 Videos | 6 Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Atoms", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Nuclei", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Semiconductor Electronics: Materials, Devices and Simple Circuits", meta:"", lectures:[], notes:[], png:[], dpp:[]}
                    ]
                    },
                    {
                        name: "Physics By Satyam Mudaliar Sir", chapters: "20 Chapters", icon: "P", bg: "#eff6ff",
                    ...
                    { name: "Inorganic Chemistry", chapters: "34 Chapters", icon: "I", bg: "#eff6ff", pageItems: [
                        {title:"All Content", meta:"All Videos | All Exercises | All Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Short Notes || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Mind Map || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"PYQ's || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Coordination Compounds", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"d and f Block Elements", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"p Block Elements", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Salt Analysis", meta:"", lectures:[], notes:[], png:[], dpp:[]}
                    ] },
                    { name: "Botany", chapters: "100 Chapters", icon: "B", bg: "#eff6ff", pageItems: [
                        {title:"All Content", meta:"All Videos | All Exercises | All Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Short Notes || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Mind Map || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"PYQ's || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Sexual Reproduction in Flowering Plant", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Principle of Inheritance and Variation", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Molecular Basis of Inheritance", meta:"", lectures:[], notes:[], png:[], dpp:[]}
                    ] },
                    { name: "Zoology", chapters: "51 Chapters", icon: "Z", bg: "#eff6ff", pageItems: [
                        {title:"All Content", meta:"All Videos | All Exercises | All Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Short Notes || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Mind Map || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"PYQ's || (Only PDF)", meta:"Notes", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Human Reproduction", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Human Health and Diseases", meta:"", lectures:[], notes:[], png:[], dpp:[]},
                        {title:"Biotechnology", meta:"", lectures:[], notes:[], png:[], dpp:[]}
                    ] }
                ],
                infinity: ["Dropper Revision", "Doubt Support", "NEET Mock Tests"]
            }
        ]
    },
    ...
    activeBatches.forEach((batch, index) => {
        ...
        container.innerHTML += `
            <div style="background:#ffffff; border:1px solid #e2e8f0; border-radius:16px; padding:12px; margin-bottom:16px; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
                ...
                ${batch.status ? `<div style="font-size:12px; font-weight:700; color:${batch.status === 'LIVE' ? '#dc2626' : '#16a34a'}; padding:10px 2px 0;">${batch.status}</div>` : ''}
                ${batch.subtitle ? `<div style="font-size:13px; color:#8a8f96; padding:8px 2px 0;">${batch.subtitle}</div>` : ''}
                ${batch.startDate ? `<div style="font-size:12px; color:#8a8f96; padding:6px 2px 0;">📅 Start Date: ${batch.startDate}</div>` : ''}
...
function openBatch(batchTitle) {
    ...
    const careerDetailStudy = document.getElementById('career-will-detail-study-wrap');
    if (careerDetailStudy) {
        careerDetailStudy.style.display = (currentInstitute === 'Career Will' && currentBatchDetails && Number.isInteger(currentBatchDetails.studyClassIndex)) ? 'block' : 'none';
    }
...
// Career Will ke batch-details se direct screenshot-style study page par jao.
function startCareerWillStudy() {
    if (currentInstitute !== 'Career Will' || !currentBatchDetails) return;
    const idx = Number.isInteger(currentBatchDetails.studyClassIndex) ? currentBatchDetails.studyClassIndex : 0;
    openSubjectLectures('', idx);
}
...
function renderContentTab(tabName) {
    ...
    list.forEach((entry, index) => {
        ...
        if (url && tabName === 'lectures') {
            action = `onclick="openInYouTube('${String(url).replace(/'/g, "\\'")}')"`;
        } else if (url) {
