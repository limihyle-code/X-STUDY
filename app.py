...
function makePageItem(title, meta, extra = {}) {
    return Object.assign({
        title: title,
        meta: meta || '',
        // Har screenshot-card ke andar user apne links/items rakh sakta hai.
        lectures: [],
        notes: [],
        png: [],
        dpp: []
                ...
                classes: [
                    {
                        ...
                        // Screenshot 1-2: chapter-list style page.
                        pageItems: [
                            makePageItem("Electric Charges and Fields", "22 Videos | 11 Exercises | 33 Notes"),
                            makePageItem("Electrostatic Potential and Capacitance", "18 Videos | 9 Exercises | 27 Notes"),
                            makePageItem("Current Electricity", "16 Videos | 5 Exercises | 21 Notes"),
                            makePageItem("Moving Charges and Magnetism", "13 Videos | 6 Exercises | 19 Notes"),
                            makePageItem("Magnetism and Matter", "4 Videos | 2 Exercises | 6 Notes"),
                            makePageItem("Electromagnetic Induction", "9 Videos | 4 Exercises | 13 Notes"),
                            makePageItem("Alternating Current", "1 Video | 1 Note"),
                            makePageItem("Electromagnetic Waves", ""),
                            makePageItem("Ray Optics and Optical Instruments", ""),
                            makePageItem("Wave Optics", ""),
                            makePageItem("Dual Nature of Radiation and Matter", "6 Videos | 6 Notes"),
                            makePageItem("Atoms", ""),
                            makePageItem("Nuclei", ""),
                            makePageItem("Semiconductor Electronics: Materials, Devices and Simple Circuits", "")
                        ]
                    },
                    {
                        name: "Physics By Satyam Mudaliar Sir", chapters: "20 Chapters", icon: "⚡", bg: "#eff6ff",
                        // Screenshot 3-4: resource cards; All Content opens screenshot 5 style chapter page.
                        pageItems: [
                            makePageItem("All Content", "All Videos | All Exercises | All Notes", {
                                subItems: [
                                    makePageItem("Electric Charges and Fields", "19 Videos | 18 Exercises | 37 Notes"),
                                    makePageItem("Electrostatic Potential and Capacitance", "17 Videos | 15 Exercises | 32 Notes"),
                                    makePageItem("Current Electricity", "15 Videos | 11 Exercises | 23 Notes"),
                                    makePageItem("Moving Charges and Magnetism", "12 Videos | 8 Exercises | 26 Notes"),
                                    makePageItem("Magnetism and Matter", "4 Videos | 2 Exercises | 7 Notes"),
                                    makePageItem("Electromagnetic Induction", "8 Videos | 6 Exercises | 17 Notes"),
                                    makePageItem("Alternating Current", "6 Videos | 5 Exercises | 13 Notes")
                                ]
                            }),
                            makePageItem("Satya Darpan Sheets|| (Only PDF)", "1 Video | 5 Notes"),
                            makePageItem("Neet Replica Practice Sheet", "6 Exercises | 6 Notes"),
                            makePageItem("PYQ's Practice Sheet", "6 Exercises | 6 Notes"),
                            makePageItem("Practice Sheet discussion", "3 Videos | 3 Notes"),
                            makePageItem("NCERT Discussion", "12 Videos | 12 Notes"),
                            makePageItem("Sattu Sir ke Concept Capsules", "13 Videos | 13 Notes"),
                            makePageItem("Weekly Revision Sheet", "11 Notes")
                        ]
                    },
                    {
                        name: "Botany By Vipin Sharma Sir", chapters: "19 Chapters", icon: "🌿", bg: "#fdf2f8",
                        // Screenshot 6-7-8 style.
                        pageItems: [
                            makePageItem("All Content", "All Videos | All Exercises | All Notes", {
                                subItems: [
                                    makePageItem("Chapter plant breeding and Tissue Culture", "2 Videos | 2 Notes"),
                                    makePageItem("VICKS By Vipin Sir", "1 Note"),
                                    makePageItem("Detailed 12th Revision", "2 Videos"),
                                    makePageItem("Sexual Reproduction in Flowering Plant", "13 Videos | 8 Exercises | 21 Notes"),
                                    makePageItem("Principle of Inheritance and Variation", "12 Videos | 8 Exercises | 20 Notes"),
                                    makePageItem("Molecular Basis of Inheritance", "16 Videos | 11 Exercises | 28 Notes")
                                ]
                            }),
                            makePageItem("NEET Bridge Course Formula Sheet", "10 Notes"),
                            makePageItem("Vipu Sir ki Revision Express", "9 Videos"),
                            makePageItem("Neet Replica Practice Sheet", "2 Exercises | 2 Notes"),
                            makePageItem("PYQ's Practice Sheet", "2 Exercises | 2 Notes"),
                            makePageItem("Detailed 11th Revision", "4 Videos"),
                            makePageItem("VIPU Sir ki Practice Sheet", "1 Note"),
                            makePageItem("NCERT Discussion", "3 Videos | 3 Notes"),
                            makePageItem("Short Notes || (Only PDF)", "7 Notes"),
                            makePageItem("Mind Map || (Only PDF)", "7 Notes"),
                            makePageItem("PYQ's || (Only PDF)", "7 Notes"),
                            makePageItem("Bridge Course Lecture", "1 Video | 1 Note"),
                            makePageItem("Lecture Concise Notes || (Only PDF)", "40 Notes"),
                            makePageItem("Handwritten Notes || (Only PDF)", "7 Notes")
                        ]
                    },
                    {
                        ...
                        pageItems: [
                            makePageItem("Neet Replica Practice Sheet", "2 Exercises | 2 Notes"),
                            makePageItem("NCERT Discussion", "3 Videos | 3 Notes"),
                            makePageItem("Summary Lecture and PYQs Discussion class", "22 Videos | 22 Notes"),
                            makePageItem("Podcast Summary class 11th || (Only Video)", "11 Videos"),
                            makePageItem("Sexual Reproduction in Flowering Plant", "25 Videos | 13 Exercises | 38 Notes"),
                            makePageItem("Principle of Inheritance and Variation", "30 Videos | 15 Exercises | 45 Notes"),
                            makePageItem("Molecular Basis of Inheritance", "23 Videos | 9 Exercises | 36 Notes")
                        ]
                    },
                    {
                        ...
                        pageItems: [
                            makePageItem("All Content", "All Videos | All Exercises | All Notes"),
                            makePageItem("Short Notes || (Only PDF)", "6 Notes"),
                            makePageItem("Mind Map || (Only PDF)", "6 Notes"),
                            makePageItem("PYQ's || (Only PDF)", "6 Notes"),
                            makePageItem("Questions and Answer key || (Only PDF)", "3 Notes"),
                            makePageItem("Tapasya Practice Sheet Zoology By Samapti", "1 Note"),
                            makePageItem("Bridge Course Lecture", "1 Video | 1 Note"),
                            makePageItem("Neet Replica Practice Sheet", "2 Exercises | 2 Notes"),
                            makePageItem("NCERT Discussion", "3 Videos | 3 Notes")
                        ]
...
function closeTeacherPage() {
    // Nested screenshot-style page se pehle parent list par wapas.
    if (teacherPageStack.length) {
        const previous = teacherPageStack.pop();
        currentTeacherItems = previous.items || [];
        document.getElementById('teacher-page-screen').style.display = 'flex';
        document.getElementById('teacher-page-title').innerText = currentTeacherClass.name || 'Teacher';
        renderTeacherPageItems();
        window.scrollTo(0, 0);
        return;
    }
...
function openContentItem(index) {
    const selectedItem = currentTeacherItems[index] || {title:'Content', lectures:[], notes:[], png:[], dpp:[]};

    // Kuch screenshot cards (jaise All Content) apna next chapter-list page kholte hain.
    if (Array.isArray(selectedItem.subItems)) {
        teacherPageStack.push({items: currentTeacherItems});
        currentTeacherItems = selectedItem.subItems;
        document.getElementById('teacher-page-screen').style.display = 'flex';
        document.getElementById('video-screen').style.display = 'none';
        document.getElementById('teacher-page-title').innerText = currentTeacherClass.name || 'Teacher';
        renderTeacherPageItems();
